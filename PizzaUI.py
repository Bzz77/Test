...
class PizzaUI:
    ...
    #     page = tk.Frame(window4)
    #     page.pack()
    #
    #     button1 = tk.Button(window4, text="Pizza Management", command=self.pagechange_main).pack(pady=10)
    #     button2 = tk.Button(window4, text="Order", command=self.pagechange_order).pack(pady=10)
    #
    #     window4.mainloop()
    ...
    def menu_order(self):
        ...
        e = []
        global m
        m = [16.79, 15.26, 18.31, 16.79, 10.68, 16.79, 16.79, 16.79, 10.68, 10.68, 4.578, 4.578, 3.052, 3.052, 3.052, 1.526]
        global e1
        lab1 = tk.Label(window2, text="1. Salami: Cheese, Salami, Tomato Sauce (no,11,15.4) - €16.79",font=("Arial", 10, "bold"), fg="grey", bg="white")
        lab1.place(x=0, y=0)
        e1 = tk.Entry(window2, show=None, font=("Arial", 15), bg="#E7E6E6")
        e1.place(x=0, y=25, width=400, height=20)
        e.append(e1)
        global e2
        lab2 = tk.Label(window2, text="2. Hawwii: Cheese, Pineapple, Tomato Sauce (yes,10,14.0) - €15.26",font=("Arial", 10, "bold"), fg="grey", bg="white")
        lab2.place(x=0, y=45)
        e2 = tk.Entry(window2, show=None, font=("Arial", 15), bg="#E7E6E6")
        e2.place(x=0, y=70, width=400, height=20)
        e.append(e2)
        global e3
        lab3 = tk.Label(window2, text="3. Salmon: Cheese, Salmon, Tomato Sauce (no,12,16.8) - €18.31",font=("Arial", 10, "bold"), fg="grey", bg="white")
        lab3.place(x=0, y=90)
        e3 = tk.Entry(window2, show=None, font=("Arial", 15), bg="#E7E6E6")
        e3.place(x=0, y=115, width=400, height=20)
        e.append(e3)
        global e4
        lab4 = tk.Label(window2, text="4. Vegetaria: Cheese, Vegetable, Tomato Sauce (yes,11,15.4) - €16.79",font=("Arial", 10, "bold"), fg="grey", bg="white")
        lab4.place(x=0, y=135)
        e4 = tk.Entry(window2, show=None, font=("Arial", 15), bg="#E7E6E6")
        e4.place(x=0, y=160, width=400, height=20)
        e.append(e4)
        global e5
        lab5 = tk.Label(window2, text="5. eMargherita: Cheese, Tomato Sauce (yes,7,9.8) - €10.68",font=("Arial", 10, "bold"), fg="grey", bg="white")
        lab5.place(x=0, y=180)
        e5 = tk.Entry(window2, show=None, font=("Arial", 15), bg="#E7E6E6")
        e5.place(x=0, y=205, width=400, height=20)
        e.append(e5)
        global e6
        lab6 = tk.Label(window2,text="6. BBQ Meat Lovers: Ham, Peperoni, MozzarellaCheese, BBQ Sauce (no,11,15.4) - €16.79",font=("Arial", 10, "bold"), fg="grey", bg="white")
        lab6.place(x=0, y=225)
        e6 = tk.Entry(window2, show=None, font=("Arial", 15), bg="#E7E6E6")
        e6.place(x=0, y=250, width=400, height=20)
        e.append(e6)
        global e7
        lab7 = tk.Label(window2,text="7. BBQ Chicken: Bell pepper, Onion, Grilled Chicken, BBQ Sauce (no,11,15.4) - €16.79",font=("Arial", 10, "bold"), fg="grey", bg="white")
        lab7.place(x=0, y=270)
        e7 = tk.Entry(window2, show=None, font=("Arial", 15), bg="#E7E6E6")
        e7.place(x=0, y=305, width=400, height=20)
        e.append(e7)
        global e8
        lab8 = tk.Label(window2, text="8. Tuna: Cheese, Tuna, Tomato Sauce (no,11,15.4) - €16.79",font=("Arial", 10, "bold"), fg="grey", bg="white")
        lab8.place(x=0, y=325)
        e8 = tk.Entry(window2, show=None, font=("Arial", 15), bg="#E7E6E6")
        e8.place(x=0, y=350, width=400, height=20)
        e.append(e8)
        global e9
        lab9 = tk.Label(window2, text="9. Pepperoni: Cheese, Pepperoni, Tomato Sauce (no,7,9.8) - €10.68",font=("Arial", 10, "bold"), fg="grey", bg="white")
        lab9.place(x=0, y=375)
        e9 = tk.Entry(window2, show=None, font=("Arial", 15), bg="#E7E6E6")
        e9.place(x=0, y=400, width=400, height=20)
        e.append(e9)
        global e10
        lab10 = tk.Label(window2, text="10. Bacon: Cheese, Bacon, Tomato Sauce (no,7,9.8) - €10.68",font=("Arial", 10, "bold"), fg="grey", bg="white")
        lab10.place(x=0, y=425)
        e10 = tk.Entry(window2, show=None, font=("Arial", 15), bg="#E7E6E6")
        e10.place(x=0, y=450, width=400, height=20)
        e.append(e10)
        global e11
        lab11 = tk.Label(window2, text="11. Tiramisu (3,4.2) - €4.578", font=("Arial", 10, "bold"), fg="grey", bg="white")
        lab11.place(x=750, y=0)
        e11 = tk.Entry(window2, show=None, font=("Arial", 15), bg="#E7E6E6")
        e11.place(x=750, y=25, width=400, height=20)
        e.append(e11)
        global e12
        lab12 = tk.Label(window2, text="12. Matcha cake (3,4.2) - €4.578", font=("Arial", 10, "bold"), fg="grey",bg="white")
        lab12.place(x=750, y=45)
        e12 = tk.Entry(window2, show=None, font=("Arial", 15), bg="#E7E6E6")
        e12.place(x=750, y=70, width=400, height=20)
        e.append(e12)
        global e13
        lab13 = tk.Label(window2, text="13. Apple Juice (2,2.8) - €3.052", font=("Arial", 10, "bold"), fg="grey",bg="white")
        lab13.place(x=750, y=90)
        e13 = tk.Entry(window2, show=None, font=("Arial", 15), bg="#E7E6E6")
        e13.place(x=750, y=115, width=400, height=20)
        e.append(e13)
        global e14
        lab14 = tk.Label(window2, text="14. Coca Cola (2,2.8) - €3.052", font=("Arial", 10, "bold"), fg="grey",bg="white")
        ...
        e17 = tk.Entry(window2, show=None, font=("黑体", 15), bg="#E7E6E6")
        e17.place(x=750, y=300, width=200, height=20)
        e17.insert(0, 'None')
        pay = tk.Button(window2, command=self.print_total, cursor="hand2", text="Finish", bd=0, font=("Arial", 12),fg="white", bg="blue")
    ...
    #     cursor = db.cursor()
    #     sql = "insert into OrderMenu(id,item,orderTime,deliveryPersonid) values('%s','%s','%s','%s')" % ()

    def customer_add(self):
        db = pymysql.connect(host="localhost", user=self.username, password=self.password, db="sys")
        cursor = db.cursor()
        sql = "insert into PizzaCustomer(name,phonenumber,address,numoforders) values('%s','%s','%s','%s')" % (
            entry10.get(), entry11.get(), entry12.get(), '1')
        try:
            cursor.execute(sql)
            db.commit()
        ...
        # sql = "select * from PizzaCustomer where name = %s" % entry10.get()
        # try:
        #     cursor.execute(sql)
        #     row = cursor.fetchone()
        #     if row is not None:
        #         sql = "update PizzaCustomer set numoforders= numoforders+1 where name= '%s'" % (entry10.get())
        #         try:
        #             cursor.execute(sql)
        #             db.commit()
        #         except Exception as err:
        #             db.rollback()
        #             print("Error: ", err)
        #         sql = "select numoforders from PizzaCustomer where name= '%s'" % (entry10.get())
        #         try:
        #             cursor.execute(sql)
        #             result = cursor.fetchone()
        #             if (result[3] % 10) == 0 and result[3] != 0:
        #                 msg.showinfo(title='Discount code!', message='Discount codeis:' + '')
        #             db.commit()
        #         except Exception as err:
        #             db.rollback()
        #             print("Error: ", err)
        #         msg.showinfo(title='success!', message='successfully ordered')
        #         print('The order will be delivered in 5 mins')
        #         print('The estimated delivery time is: ' + str(datetime.datetime.now() + datetime.timedelta(minutes=15)))
        #     else:
        #         sql = "insert into PizzaCustomer(name,phonenumber,address,numoforders) values('%s','%s','%s','%s')" % (
